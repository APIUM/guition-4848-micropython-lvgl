/*
 * LVGL configuration for Guition ESP32-S3-4848S040 demo.
 * Based on lv_conf_template.h from LVGL v9.3.0 with project customisations
 * (enabled fonts, colour depth, memory settings, demo widgets).
 * Copied into the build tree by drivers/build.sh.
 */
/**
 * @file lv_conf.h
